            ...
            <div className="container text-center mt-5 service-btn-max" data-aos="fade-right" data-aos-delay="500">
                ...
                <div className="btn-wrapper">
                    ...
                    <div className="btn-content">
                        ...
                        <div className="btn-text">TELL US YOUR CHALLENGE</div>
                    </div>
                </div>
            </div>
                ...
                <div className="container">
                    ...
                    <div className="row mt-5 align-items-center">
                        <div className="col-lg-6" data-aos="fade-left" data-aos-delay="2000">
                            <video src="/images/consulting-page-video2.mp4" className='img-fluid' autoPlay loop playsInline muted controls={false}></video>
                        </div>
