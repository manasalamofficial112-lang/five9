        ...
        <>
            ...
            <section className="dashboard-inner-pages">
                <div className="container-fluid">
                    <h2 className="db-hd">Edit Home Page Banner Background Video</h2>
                    <form action="" className="db-form" encType="multipart/form-data">
                        <label htmlFor="header-logo" className="db-hd-mini">Edit Video</label>
                        <input type="file" name="header-logo" id="header-logo" className="header-input" placeholder='Enter Video URL' accept="image/*" required />
                    </form>
