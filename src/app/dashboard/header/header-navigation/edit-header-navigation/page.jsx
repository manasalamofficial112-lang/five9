            ...
            <section className="dashboard-inner-pages">
                <div className="container-fluid">
                    ...
                    <form action="" className="db-form" encType="multipart/form-data">
                        <label htmlFor="header-name" className="db-hd-mini">Edit Page Name</label>
                        <input type="text" name="header-name" id="header-name" className="header-input" placeholder="Enter Page Name" required />
